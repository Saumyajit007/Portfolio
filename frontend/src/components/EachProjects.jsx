...
Link
function EachProjects({ imageurl = images, projectname = "Frontend Projects", description = "Some of my frontend practice project using HTML CSS & JavaScript" }) {
  ...
  return (
    <div className='h-fit max-w-screen my-[20px] mx-[15px] bg-[rgb(202,249,239)] shadow-md hover:scale-105 rounded-2xl cursor-pointer overflow-hidden relative project sm:my-[40px] sm:mx-[30px] lg:max-w-[60%] lg:mx-auto'>
      <Link to="https://github.com/Saumyajit007/Saumyajit007-Frontend_Projects" >

    ...
    <div className='pt-16 sm:pt-20 min-w-[100vw]'>
      ...
      <div className=' py-[20px] px-[10px]'>
        ...
        <div className='flex sm:justify-around flex-col sm:flex-row'>
          <div className='h-fit w-[340px] sm:h-[450px] sm:w-[500px] p-1 sm:p-6 sm:m-4 m-1 overflow-hidden rounded-xl shadow-[0px_20px_30px_-10px_rgba(38,57,77,1)] hover:shadow-[rgba(0,0,0,0.25)_0px_54px_55px,rgba(0,0,0,0.12)_0px_-12px_30px,rgba(0,0,0,0.12)_0px_4px] border-black border-2 sm:border-none'>
